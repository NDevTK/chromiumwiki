...
* **Input Validation:** All user inputs should be validated to prevent various attacks, including buffer overflows and command injection.  Specifically, the PIN entry dialog should enforce a six-digit numeric PIN.
