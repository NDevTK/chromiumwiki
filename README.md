...
*   **Techniques & VRP Patterns:**
    ...
    *   **Dialog/Prompt Spoofing:** Investigate UI origin/content confusion.
        ...
        *   *Download UI:* Incorrect origin shown (long subdomain VRP2.txt#8323, #8581; `about:srcdoc` VRP2.txt#11028). See [downloads.md](downloads.md).
